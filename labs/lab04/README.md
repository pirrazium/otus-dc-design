...
В случае использования juniper'ов, можно было бы более точно настраивать peer group и указывать listen range более тонко, в нашем же случае для ptp используются сети вида 10.[16-17].[101-103].0/30, добавить несколько сетей мы не можем из-за особенностей архитектуры, а добавлять на listen 10.16.0.0/15 или вовсе более широкие. 
